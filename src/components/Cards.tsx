...
const projects: Project[] = [
  {
    ...
    imageUrl:
      "https://www.bunnycart.com/blog/wp-content/uploads/2019/01/Aquascaping-an-Aquarium.jpg",
  },
  {
    title: "KODAMA",
    ...
    imageUrl:
      "https://img.freepik.com/free-photo/autumn-leaf-falling-revealing-intricate-leaf-vein-generated-by-ai_188544-9869.jpg?size=626&ext=jpg&ga=GA1.1.1314780943.1727161200&semt=ais_hybrid",
  },
  {
    title: "ECO GARDEN",
  ...
  },
  {
    ...
    imageUrl:
      "https://aquascape.ae/wp-content/uploads/2023/09/1000090335-scaled.jpg",
  },
];
...
const ProjectInfo: React.FC<{ project: Project; isActive: boolean }> = ({
  project,
  isActive,
}) => {
  return (
    ...
    >
      ...
      >
        {project.tags.map((tag, tagIndex) => (
          <span
            key={tagIndex}
            className="text-sm text-white bg-black/50 rounded-full px-4 py-2"
          >
            {tag}
          </span>
        ))}
...
export default function Cards() {
  ...
  useEffect(() => {
    if (containerRef.current) {
      const targetScroll =
        window.innerHeight + activeIndex * window.innerHeight;
      window.scrollTo({
        top: targetScroll,
        behavior: "smooth",
      });
